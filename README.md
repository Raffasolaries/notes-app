...
## Signup creating Cognito Credentials

Once the stack is deployed, it's time to Signup following the link given into the CloudFormation output: **SingupURL**. It gives back the **access_token** that has to be used as JWT Bearer Token in the request header to Authorize HTTP requests.
